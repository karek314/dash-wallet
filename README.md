This is fork of android dash-wallet. This version allow to retrieve lost spending pin in case it's numeric. It has hardcoded minimal value of pin as 1000 without maximum limitation. In order to use - Go to Settings > Safety > Change Spending Pin
